...
if __name__ == '__main__':
    ...
    SAVEDIR_PREFIX = f'/cluster/daidalos/abokhovkin/DeepSDF_v2/ShapeNetV2_dim256_partial_uniform/SdfSamples/ShapeNetV2/02933112'
        ...
        try:
            ...
            for child_name in part_to_geo:
                ...
                for k in range(10):
                    ...
                    np.savez(outfile,
                             pos=grid_points_pos_sampled, neg=grid_points_neg_sampled,
